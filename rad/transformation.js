...
SceneTransforms.prototype.calculatePerspective = function(){
    ...
    mat4.perspective(c.FOV, W / H, c.minZ, c.maxZ, this.pMatrix);
};
...
SceneTransforms.prototype.updatePerspective = function(){
    var c = this.camera;
    mat4.perspective(c.FOV, W / H, c.minZ, c.maxZ, this.pMatrix);  // We can resize the screen at any point so the perspective matrix should be updated always.
};
